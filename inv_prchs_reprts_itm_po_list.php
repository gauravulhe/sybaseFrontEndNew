        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="prchsreportsexports" target="_blank" action="prchs_reports/prchs_reprts_itm_po_list.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>
                                            <th>From Date</th>
                                            <td><input type="text" name="fr_poh_po_dt" id="fr_poh_po_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Date</th>
                                            <td><input type="text" name="to_poh_po_dt" id="to_poh_po_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Item</th>
                                            <td><input type="text" name="fr_pod_item" id="fr_pod_item" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Item</th>
                                            <td><input type="text" name="to_pod_item" id="to_pod_item" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>P.O. Limit</th>
                                            <td><input type="text" name="po_limit" id="po_limit" value="25000" required maxlength="4" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>File Name</th>

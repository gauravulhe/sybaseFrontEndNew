                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>                                            
                                            <th>Code</th>
                                            <td><input type="text" name="sup_supcd" id="sup_supcd" readonly maxlength="4" size="1" onblur="CheckSupCatCd()" style="text-transform: uppercase" required>                 

...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT 
			...
			cod.cod_prefix = 6
			WHERE gpa_com = $gpa_com AND gpa_unit = $gpa_unit AND gpa_dt  BETWEEN '$fr_gp_dt' AND '$to_gp_dt'";
...
?>
	<table border="0" width="100%">
		<tr class="bg-color">
			<th colspan="3">Pending Gate Pass Register </th>
		</tr>
		<tr>
			<th  width="22%" style="text-align:left">Pending Gate Pass Register Dt </th>
			<th> : </th>
			<td><?php echo date('d.m.Y', strtotime($fr_gp_dt)).' To '.date('d.m.Y', strtotime($to_gp_dt)); ?></td>
		</tr>
		<tr>
			<th  width="22%" style="text-align:left">Company Name </th>
			<th> : </th>
			<td><?php print_r($rows[0]['com_name']); ?></td>
		</tr>
		<tr>
			<th  width="22%" style="text-align:left">Company Unit </th>
			<th> : </th>

...
if (isset($_POST['submit'])) {
	...
	$sql = "SELECT 
			...
			dept.dep_prefix = 3
			WHERE gpa_com = $gpa_com AND gpa_unit = $gpa_unit AND gpa_no BETWEEN $fr_gp_no AND $to_gp_no AND gpa_dt  BETWEEN '$fr_gp_dt' AND '$to_gp_dt'";

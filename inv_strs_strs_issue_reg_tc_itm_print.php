        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="issue" action="issue_prints/issue_reg_tc_item_print.php" target="_blank" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>               
                                            <th>TC</th>
                                            <td><input type="text" name="iss_tc" id="iss_tc"  maxlength="3" size="10" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>From Item</th>
                                        ...
                                        <tr>               
                                            <th>From A/C</th>
                                            <td><input type="text" name="fr_iss_ac" id="fr_iss_ac" value="0000000"  maxlength="7" size="10" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>To A/C</th>
                                            <td><input type="text" name="to_iss_ac" id="to_iss_ac" value="9999999" maxlength="7" size="10" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>File Name</th>

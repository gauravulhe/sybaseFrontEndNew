        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="gpreportsexports" target="_blank" action="gp_reports/gp_rprts_rgstr_print.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="gpa_ryn" id="gpa_ryn" required maxlength="6" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Date</th>

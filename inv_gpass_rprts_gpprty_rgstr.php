        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="gpreportsexports" target="_blank" action="gp_reports/gp_rprts_party_rgstr_print.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>
                                            <th>From Party</th>
                                            <td><input type="text" name="fr_gp_party" value="A000" id="fr_gp_party" required maxlength="4" size="4" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Party</th>
                                            <td><input type="text" name="to_gp_party" value="Z999" id="to_gp_party" required maxlength="4" size="4" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>File Name</th>

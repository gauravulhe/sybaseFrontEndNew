        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="prchsreportsexports" target="_blank" action="prchs_reports/prchs_reprts_spplr_pndng_list.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>
                                            <th>From Item No</th>
                                            <td><input type="text" name="fr_item_no" id="fr_item_no" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Item No</th>
                                            <td><input type="text" name="to_item_no" id="to_item_no" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Party</th>
                                            <td><input type="text" name="fr_party" id="fr_party" value="A000" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Party</th>
                                            <td><input type="text" name="to_party" id="to_party" value="Z999" required maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Date</th>
                                            <td><input type="text" name="fr_po_dt" id="fr_po_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Date</th>
                                            <td><input type="text" name="to_po_dt" id="to_po_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>Pending Days</th>
                                            <td><input type="text" name="pndng_days" id="pndng_days" required maxlength="4" size="1" style="text-transform: uppercase">
                                            ( 9999 For All )
                                            </td>
                                        </tr>
                                        <tr>

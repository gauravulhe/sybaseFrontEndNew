        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="issue" action="issue_prints/issue_slips_print.php" target="_blank" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>               
                                            ...
                                            <td><input type="text" name="iss_tc" id="iss_tc"  maxlength="3" size="1" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>From Date</th>
                                        ...
                                        <tr>               
                                            <th>From Issue No</th>
                                            <td><input type="text" name="fr_iss_no" id="fr_iss_no"  maxlength="20" size="10" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>To Issue No</th>
                                            <td><input type="text" name="to_iss_no" id="to_iss_no"  maxlength="10" size="10" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td> 
                                        </tr>
                                        <tr>               
                                            <th>File Name</th>

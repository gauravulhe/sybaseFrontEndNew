        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="prchsreportsexports" target="_blank" action="prchs_reports/prchs_reprts_itm_prchs.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" name="grd_com" id="com_com"  maxlength="3" size="1" onblur="CheckComCd()" required onkeyup="CheckInputNumFormat(this.value)">
                                            </td>          
                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <th>Unit Code</th>
                                            <td><input type="text" name="grd_unit" id="mat_unit"  maxlength="3" size="1" required  onblur="CheckMatMastUntCd()" onkeyup="CheckInputNumFormat(this.value)">
                                            </td>
                                            <td colspan="4">
                                        ...
                                        <tr>
                                            <th>From Date</th>
                                            <td><input type="text" name="fr_grd_dt" id="fr_grd_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To Date</th>
                                            <td><input type="text" name="to_grd_dt" id="to_grd_dt" required readonly maxlength="7" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Item</th>

        ...
        <div>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <form role="form" name="gpreportsexports" target="_blank" action="gp_reports/gp_prntng_print.php" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table cellpadding="1">
                                        ...
                                        <tr>
                                            <th>From GP No</th>
                                            <td><input type="text" name="fr_gp_no" id="fr_gp_no" required maxlength="6" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>To GP No</th>
                                            <td><input type="text" name="to_gp_no" id="to_gp_no" required maxlength="6" size="6" style="text-transform: uppercase"></td>
                                        </tr>
                                        <tr>
                                            <th>From Date</th>

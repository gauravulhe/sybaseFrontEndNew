<div class="hr-divider"><hr></div>
		...
		<div class="content">
			<table width="100%">
				<tr>
					...
					<td width="10%" align="center">
						<?php 
							$ChaptIdCd = $resultChal['chptid']; 
							$queryChaptIdDesc = "SELECT chp_subhd1 FROM catalog.sales.chpthead WHERE chp_id = $ChaptIdCd";
							$resultChaptIdDesc = odbc_exec($conn, $queryChaptIdDesc);
							$ChaptIdDesc = odbc_result($resultChaptIdDesc, 1);
							echo $ChaptIdDesc;
			...
			<?php 
				...
				$line_break = ($_POST['line_break'])?$_POST['line_break'] : 38;
				if ($i % $no_of_records == 0) { 
				require('challan_print_footer.php');
				while ($line_break >= 0) {
					echo '<br>';
					$line_break--;
				}				
